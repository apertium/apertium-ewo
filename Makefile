all:
	...
	hfst-lexc apertium-ewo.ewo_Miss.phon | hfst-invert | hfst-compose -1 - -2 ewo.spellrelax.hfst | hfst-invert -o ewo_OGC-ewo_Miss.conv.hfst
	hfst-fst2fst -w ewo_OGC-ewo_Miss.conv.hfst -o ewo_OGC-ewo_Miss.autoconv.hfst
	hfst-lexc apertium-ewo.ewo.lexc -o ewo.lexc.hfst
	hfst-compose -1 ewo.lexc.hfst -2 ewo.spellrelax.hfst -o ewo.lexc.spell.hfst
	hfst-compose -1 ewo.lexc.hfst -2 ewo_OGC-ewo_Miss.conv.hfst -o ewo.lexc.miss.hfst
